/**
 *Completion source
 *This is your source, an array of irc nicks (in part the "#ubuntu" users list
...
var nicks = ["@Flood Bot1", "@Flood Bot2", "acmeinc1", "b1g1r0n", "Odd-rationale", "oddie", "Odysimus", "OerHeks",
             ...
             "ppyhd", "pr0nto", "pr0ton", "bananenkampf-de", "Praxi", "PreZGN", "Pricey", "Prodego", "profxavier",
             "ProgR33n", "prooz", "pse", "Psi-Jack", "psx_", "bandroidx", "puffin", "puff_", "puikula", "pushpop",
             "pwnt", "Pyrat", "pystar90", "QA", "qazokm", "qdk", "bantu", "qngo", "Quaydon", "Qub1t", "quebre",
             "quiescens", "Radium", "rage", "raido", "Rains", "raketti", "acrocity", "barend", "Rallias",
             "Random832", "Random___", "rasusto", "ratifers", "RaTTuS|BIG", "raven", "rax-", "Rayston", "razmataz",
             "Barridus", "ready", "rebe", "RedBunny", "RedCap", "redrocket", "regedarek", "relurk`", "remoteCTRL",
             "retoaded", "RevHelix", "Barzogh", "rexbron_", "rexor", "rfoust", "rhizmoe", "RichardBronosky",
             "Richard_Cavell", "Richiie", "ricky26", "Riddell", "rikut", "basepi", "rioderelfte", "ripps",
             "RiXtEr-Home", "rns", "roasted", "robertf", "Robert__", "RobinJ", "robinsmidsrod", "rob_p",
             "basic`", "rogst", "Rokixz", "roknir", "roland", "Rondom", "rooot", "root_", "rosseaux", "rtnb",
             "Rurd2di", "basso", "RussellB28", "rwlove", "ry", "ryan-c", "rymate1234", "rypervenche", "rzwodzwo",
             "s0enke", "S0lo", "S0|ar|s", "alejandromg", "sacarlson", "saienia", "Sami345", "sardonyx", "Saring",
             "satyanash", "sawjig", "sa`tan", "sburjan`", "schaelle", "batrick", "schlaftier", "schmidtm",
             "schnuffle1", "Schoentoon", "scintillae", "Scunizi", "sdx23", "seanbright", "SebastianFlyte",
             "seb_", "Bauldrick", "Sedated", "semeion", "semitones", "Senix", "ses1984", "setmeaway", "Seveas",
             "Sevki", "SeySayux", "sfrancis", "bazhang_", "Sh3r1ff", "Shadowcat", "shadowe989", "shagrath",
             "shaneo", "shang", "ShapeShifter499", "Shaun", "shen-, inja", "shinkamui", "adac", "bburhans",
             "Shinobi", "Shirakawasuna", "Shojo", "shoogz", "ShooterMG", "Shyne", "Sickki", "Sid7", "signal0",
             "sig_wall", "bctrainers", "simplexio", "sins-", "Siphax", "Sirion", "sjefen6", "SJr", "skaet",
             "skenmy", "skfin", "ski_", "bdi", "skoef", "skvweeshghaar", "slacker_nl", "slackin_", "sladen",
             "Slasher`", "slikts", "SlimG_", "slobro", "sluther", "bean", "SmartTowel", "smg60231_", "smokie",
             "smw", "snap_", "snow_usa", "Socket-", "soderluk", "sohocoke", "solid_liq", "beasty", "Somefellow",
             "Someguy123", "someone235", "somnambulant", "sonnyfw", "soplaz", "soreau", "SoulShadow",
             "spacebarbarian", "spacebug-", "beatbreaker", "spacetime", "Spage", "Spanky", "sparkybluefox", "Spec",
             "SpitfireWP", "spm_", "sporous", "ssta", "ssureshot", "BedMan", "StaffGiraffe", "Staffpony", "stamina",
             "staticsafe", "Stava", "stein-on", "Stek_Turku", "StevenR", "stokachu", "StuckDK", "beerbro",
             "subthalamus", "sudokode", "SugarCube", "sumeetsk", "sunfun", "SunTsu", "surfdue", "surskitty",
             "susundberg", "Svendsen", "Belial`", "Svetlio", "microp11", "svm_invictvs", "s_Sebastian", "sw0rdfish",
             "swamptin", "SwedeMike", "swex", "Swish", "syslq", "bellman", "szal", "s_p_or_t_o", "T-One", "t0h",
             "tabakhase", "Tabmow", "tabris|away", "Taftse", "tajys", "tale", "adan0s", "Ben64", "tapout",
             "tavasti", "tazjin", "TBoxley-Server", "tdmackey", "tdn", "tdowg1", "technoviking", "tehbaut",
             "tekonivel", "ben64_", "Temex", "Tenche", "Termana|rdlBNC", "TheBeast", "theborger", "thedancingdeer",
             "thedonvaughn", "TheFuzzball", "themill", "TheSarge", "benpro", "thethomaseffect1", "thethomaseffect2",
             "the_real_crimper", "thiagoalmeidasa", "thinced", "thirsteh", "ThomasBoxley", "Thor^^", "thot_",
             "thyri0n", "BernardV", "tieinv", "tightwork", "TimeRider", "Tiven", "tjiggi_fo", "tlvb", "tlyu", "tMH",
             "TML-prv", "Tm_T", "beta0x64", "Tm_Tr", "Toggi3", "tomaw", "tommyfun", "tonesfrommars", "tonsofpcs",
             "toobluesc", "TOoSmOotH", "Toph2", "Topslack", "betz", "TorbenBeta", "torvald", "totesmuhgoats",
             "toxboi", "toytoy", "tparker", "tr-808", "tr3v3lyn", "Tradie96", "tRank", "Bhullnatik", "Travis-42",
             "TREllis", "trench", "treshoem", "treymul", "triscuit", "trism", "Tristam", "tritium", "trumee",
             "bicranial_", "tsimpson", "Ttech", "ttl-", "ttmatt", "ttt_", "tty01", "tumppu", "Tuna-Fish",
             "tuxomatix", "Twinkletoes", "BiggFREE", "txdv", "txomon", "txwikinger", "Tzunamii", "T_H_X",
             "U-b-u-n-t-u", "Ua2", "ubottu", "uBOTu-fr", "Ububegin", "bildramer", "ubuntulog", "ugubugu",
             "ulimit", "ulio", "UltimediaOS1", "Uncle|Sam", "UndergrounD", "undert-", "uni4dfx", "unixfg", "adante",
             "bindi", "unop", "UrB", "Urist_McTiktalik", "Vampire0", "Vanadis__", "VaNNi", "Varazir", "vasuki1",
             "ve7wnk", "veagles", "bipolar", "vector", "vega-_", "venkatman", "ventz", "Vert", "vexus", "vicious_",
             "viddy", "viis", "vinic", "birdy123", "virusuy", "Visual`", "vladi4ko", "vlt", "voodoo123x", "VunKruz",
             "vyrgozunqk", "w0rst", "wagle", "walden", "Birliban", "walidb", "walmis", "Walther", "wangerin1",
             "wapko", "warfaren", "warpaint", "wassy121_", "wataken44", "WebDawg", "BitchiH", "weltzooo", "wesley",
             "wespee", "wgas", "Whiskey", "whoever", "whonch", "Wi1d", "wica", "Wicet", "bitmonk", "wiiguy",
             "wildc4rd", "wilfish", "williammanda", "Will|", "WilsonBradley", "winXperts", "wish^",
             "wizonesolutions", "wolfric", "bja", "Womkes", "WoOh", "Wooooooood", "woo__", "workcjk", "wylde",
             "WyriHaximus", "Xabster", "XceptN", "XDESIGN", "bjodah", "xeros", "xerox1", "XeroXer", "xgpt", "xilo",
             "Xiol_", "Xjs|moonshine", "XLV", "xnavor", "xrdodrx", "bjorn_248", "XReaper", "xtr-2", "XuMuK",
             "xxghostxx", "xxiao", "y4h0", "yacc", "YankDownUnder", "yashshah", "Ycarene", "bkerensa", "YeahRight_",
             "yeats", "yeehaw", "ygolde_", "yorick", "Yosique", "yugnip", "yumaokao", "Y_Ichiro", "zacarias",
             "AdedioR", "black", "zaggynl", "Zaitzev", "zalbisser", "zamba", "zanoi", "ZarroBoogs", "zay", "Zed`",
             "Zeit|awy", "zelluz", "BladedThesis", "zendeavor", "ZenGuy311", "zenguy_vm", "zenix`", "zenon_",
             "zeph97", "zer0her0", "zeroedout", "Zethrok", "zeTweogon1", "bladernr_afk", "Ziber", "zilla",
             "ZinovaS", "zivester", "ziyadh", "zmaj", "Znarf", "znull", "Zol", "zonum", "Bladerunner", "zorx",
             "ZsoL", "Ztane", "zth", "zvonkorp", "zykes-", "zykotick9", "[deXter]", "[E]sc", "[Relic]", "BlakJak",
             "^Zaz", "_B00", "_flood", "_Freejack_", "_GoRDoN_", "_harri_", "_k2s_", "_Nano", "_NiC", "_ruben",
             "blami", "_S4MUR4I_", "__marix", "|DM|", "|Long|", "|_ocke", "BlankVerse", "blast_hardcheese",
             "Blauskae1M", "blinkyb", "Adie", "blitzkev", "blitzkrieg3", "BlouBlou", "Blue1", "bluebomber",
             ...
             "Darwin4Ever", "Dave2", "davidcalle", "DaZ", "a111", "Akuma", "dcat", "dcg", "dduffey", "Deathvall122",
